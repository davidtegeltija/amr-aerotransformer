...
if __name__ == "__main__":
    ...
    plot_mesh(sample, token_list, save_path=save_path)
    # plot_mesh_by_depth(sample, token_list, save_path=save_path)
    # plot_patch_features(sample, token_list, channel=0, save_path=save_path)
